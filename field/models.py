...
class Field(models.Model):
    ...
    null = models.BooleanField(
        default=False, help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#null')
    blank = models.BooleanField(default=False,
                                help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#blank')
    default = models.CharField(max_length=255, blank=True,
                               help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#default')
    help_text = models.CharField(max_length=255, blank=True,
                                 help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#primary-key')
    primary_key = models.BooleanField(default=False,
                                      help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#primary-key')
    unique = models.BooleanField(default=False,
                                 help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#unique')
    verbose_name = models.CharField(max_length=255, blank=True,
                                    help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#verbose-name')
    db_index = models.BooleanField(default=False,
                                   help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#db-index')
...
class RelationFieldOption(Field):
    ...
    related_name = models.CharField(max_length=255, blank=True,
                                    help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.ForeignKey.related_name')
...
class CharField(Field):
    ...
    choices = models.TextField(blank=True,
                               help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#choices')
    max_length = models.PositiveSmallIntegerField(default=255,
                                                  help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.CharField.max_length')
    form = 'CharFieldForm'
...
class DateField(Field):
    auto_now = models.BooleanField(default=False,
                                   help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.DateField.auto_now')
    auto_now_add = models.BooleanField(default=False,
                                       help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.DateField.auto_now_add')
    form = 'DateFieldForm'
...
class DecimalField(Field):
    max_digits = models.PositiveSmallIntegerField(default=5,
                                                  help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.DecimalField.max_digits')
    decimal_places = models.PositiveSmallIntegerField(default=2,
                                                      help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.DecimalField.decimal_places')
...
class FileField(Field):
    ...
    upload_to = models.CharField(max_length=255,
                                 help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.FileField.upload_to')
    form = 'FileFieldForm'
...
class FilePathField(Field):
    path = models.CharField(max_length=255,
                            help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.FilePathField.path')
    match = models.CharField(max_length=255,
                             help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.FilePathField.match')
    recursive = models.BooleanField(default=False,
                                    help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.FilePathField.recursive')
...
class ImageField(FileField):
    height_field = models.CharField(max_length=255, blank=True,
                                    help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.ImageField.height_field')
    width_field = models.CharField(max_length=255, blank=True,
                                   help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.ImageField.width_field')
    form = 'ImageFieldForm'
...
class URLField(Field):
    ...
    verify_exists = models.BooleanField(default=True,
                                        help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.URLField.verify_exists')
    form = 'URLFieldForm'
    field_type = 'URLField'
...
class XMLField(Field):
    schema_path = models.CharField(max_length=255,
                                   help_text='http://docs.djangoproject.com/en/1.2/ref/models/fields/#django.db.models.schema_path')
    form = 'XMLFieldForm'
    field_type = 'XMLField'
