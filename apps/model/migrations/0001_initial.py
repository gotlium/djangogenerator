...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Model'
        db.create_table('model_model', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(related_name='models', to=orm['application.Application'])),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('verbose_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('verbose_name_plural', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('db_table', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('has_read_only_view', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_form_view', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_admin_view', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('model', ['Model'])

        # Adding model 'Permissions'
        db.create_table('model_permissions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='permissions', to=orm['model.Model'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=55)),
        ))
        db.send_create_signal('model', ['Permissions'])


    def backwards(self, orm):
        # Deleting model 'Model'
        db.delete_table('model_model')

        # Deleting model 'Permissions'
        db.delete_table('model_permissions')
