...
from apps.model.forms import NewModelForm, ModelForm
...
@login_required
def get_select_values(request, model_id):
    obj_list = ModelFieldProxy.objects.filter(model__pk=model_id)
    return HttpResponse(simplejson.dumps(
        [[obj.pk, obj.object.name] for obj in obj_list])
    )
