...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('project_project', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['model.Model'], unique=True, null=True, blank=True)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('project', ['Project'])

        # Adding unique constraint on 'Project', fields ['owner', 'name']
        db.create_unique('project_project', ['owner_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['owner', 'name']
        db.delete_unique('project_project', ['owner_id', 'name'])
